...
class AVLTree
{
  ...
  public:
    ...
    int getHeight(const Node* subtree);
    ...
    */
    ...
    // bool leftHeavy(const Node* subroot)//;
    // {
    //   if (subroot == NULL) {
    //     return false;
    //   }
    //   int lHeight = -1;
    //   if(subroot->left) lHeight = subroot->left->height;
    //   else lHeight = -1 ;
    //   int rHeight = -1;
    //   if(subroot->right) rHeight = subroot->right->height;
    //   else rHeight = -1 ;
    //
    //   return lHeight > rHeight;
    // }
    //
    // bool rightHeavy(const Node* subroot)//;
    // {
    //   if (subroot == NULL) {
    //     return false;
    //   }
